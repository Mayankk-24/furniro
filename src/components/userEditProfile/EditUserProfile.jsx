...
function EditUserProfile() {
  ...
  const validationSchema = Yup.object({
    ...
    email: Yup.string()
      .email('Invalid email. Please include an "@" in the email address.')
    ...
    <>
      <div className="max-w-7xl mx-auto">
        <div className="px-2 pt-2">
          <Link
            to={"/"}
            className="flex items-center gap-x-2 w-fit text-black hover:text-black transition delay-150 duration-300 ease-in-out hover:-translate-y-1 hover:underline"
          >
            <BsArrowLeft
              color="black"
              size={20}
              className="hover:-translate-x-1 transition duration-200 delay-100 ease-in-out"
            />
            Go back
          </Link>
        </div>
        ...
        <div className="flex flex-col md:flex-row pb-10">
          <div className="w-full md:w-2/6 md:border-r">
            <div className="py-10 w-4/5 mx-auto">
              <ProfileUpload setimage={imageSet} />
            </div>
            <div className="w-4/5 mx-auto flex flex-col gap-y-3">
              <div
                className={`py-4 text-center text-black  ${
                  Select == 1
                    ...
                    : "hover:bg-gray-300/50 hover:text-black hover:cursor-pointer"
              ...
              <div
                className={`py-4 text-center  ${
                  Select == 2
                    ? "bg-gray-900 text-white font-medium"
                    : "text-black hover:bg-gray-300/50 hover:cursor-pointer"
                } rounded-lg transition duration-300 ease-in-out`}
                onClick={() => toggle(2)}
              >
                My Orders
            ...
            {Select == 1 && (
              <>
                ...
                <motion.form
                  ...
                  action="#"
                  className="max-w-3xl mx-auto rounded-lg p-5 md:p-10 shadow-lg backdrop-blur-md border-2"
                ...
                >
                  ...
                  <div className="mt-5">
                    <Input
                      ...
                      type="text"
                      name="address"
                      placeholder="230, Brooklyn New york"
                      variant="bordered"
                  ...
                  <div className="mt-5">
                    ...
                    {formik.touched.zipcode && formik.errors.zipcode ? (
                      <div
                        className="text-xs
                                text-[#FF5630] font-medium px-2 pt-2"
                      >
                  ...
                  <div className="mt-5 flex justify-center">
                    <Button
                      type="submit"
                      isLoading={loading}
                      className="bg-[#18181b] font-semibold text-white hover:bg-[#27272a] hover:shadow-lg w-1/2 focus:outline-none"
                      radius="sm"
                    >
                      Save changes
                    </Button>
