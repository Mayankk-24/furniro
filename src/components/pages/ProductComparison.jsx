    ...
    return (
        <>
            <div className='w-full bg-cover' style={{ backgroundImage: 'url("/Assets/Rectangle 1.png")', height: '316px' }}>
                <div className='flex items-center justify-center h-full'>
                    <div>
                        ...
                        <h2 className='text-center text-black text-5xl font-medium mb-4'>Product Comparison</h2>
            ...
            <div className="container flex px-20 py-10">
                <div className='pt-5'>
                    <h2 className='text-3xl text-black font-medium mb-4'>Go to Product <br /> page for more <br />
                        Products</h2>
                    <h5 className='text-[#727272] text-xl font-medium underline underline-offset-4 '>View More</h5>
                </div>
                        ...
                        Cmp?.filter((item) => cmp.includes(item._id)).map((item, index) => {
                            return (
                                <div key={index}>
                                    ...
                                    <h2 className='text-black font-medium text-2xl mt-4'>{item.title}</h2>
                                    <h2 className='text-lg font-medium text-black mt-0.5'>Rs. {item.price}</h2>
                                    <div className=' flex items-center'>
                                        <span className='text-lg font-medium text-black mr-2'>{item.review}</span>
                                        <div><Rating defaultValue={item.review} precision={0.5} /></div>
                                        <div className='text-sm text-[#9F9F9F] font-normal before:content-[" "] before:mx-4 before:text-gray-400 before:inline-block before:h-12 before:border-l-2 flex items-center'>207 Review</div>
                                    </div>
                                </div>
                            )
                        })
                ...
                <div className='pt-10'>
                    <div className='ml-24'>
                        <h2 className='text-black text-2xl font-semibold mb-4 '>Add A Product</h2>
                        <Link to={'/shop'} className='bg-primary text-white font-semibold flex items-center justify-between px-3 py-3 rounded-lg hover:text-white'>Choose a Product <RiArrowDownWideFill className='ml-10' size={25} /></Link>
                    </div>
                </div>
            </div>
            ...
            <div className="mx-10 border-t-2 pr-80 pb-24">
                ...
                <div>
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                        ...
                        <div className='border-r-2 pt-8 pl-12'>
                            <h2 className="text-black text-[28px] inline-block font-medium mb-7">General</h2>
                ...
                <div>
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                        ...
                        <div className='border-r-2 pt-16 pl-12'>
                            <h2 className="text-black text-[28px] font-medium mb-5">Product</h2>
                            <div className="space-y-5  text-black text-xl pr-4">
                                <div>Filling Material</div>
                                <div>Finish Type</div>
                                <div>Adjustable Headrest</div>
                ...
                <div>
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                        {/* First Column: Labels */}
                        <div className='border-r-2 pt-16 pl-12'>
                            <h2 className="text-black text-[28px] font-medium mb-5">Dimensions</h2>
                            <div className="space-y-5  text-black text-xl pr-4">
                                <div>Width</div>
                                <div>Height</div>
                                <div>Depth</div>
                ...
                <div>
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                        <div className='border-r-2 pt-16 pl-12'>
                            <h2 className="text-black text-[28px] font-medium mb-5">Warranty</h2>
                            <div className="space-y-12  text-black text-xl pr-4">
                                <div>Warranty Summary</div>
                                <div>Warranty Service <br />
                                    Type</div>
                                <div className='pt-[57px]'>Covered in Warranty</div>
                                <div>Not Covered in <br /> Warranty</div>
                                <div className='pt-28'>Domestic Warranty</div>
                            </div>
                        </div>
                        <div className="space-y-5 border-r-2 text-black text-xl pr-4 pl-12 pt-[126px]">
                            <div>1 Year Manufacturing Warranty</div>
                            <div>For Warranty Claims or <br /> Any Product Related <br /> Issues Please Email at operations@trevifurnitu <br /> re.com</div>
                            <div>Warranty Against Manufacturing Defect</div>
                            <div>The Warranty Does Not <br /> Cover Damages Due To <br /> Usage Of The Product <br />Beyond Its Intended Use <br /> And Wear & Tear In The Natural Course Of Product Usage.</div>
                            <div className='pb-10'>1 Year</div>
                            <button className='text-xl text-white bg-primary rounded-none focus:outline-none px-11'>Add To Cart</button>
                        </div>
                        <div className="space-y-5 border-r-2 text-black text-xl pr-4 pl-12 pt-[126px]">
                            <div>1.2 Year Manufacturing Warranty</div>
                            <div>For Warranty Claims or <br /> Any Product Related Issues Please Email at support@xyz.com</div>
