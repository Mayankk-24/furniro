      ...
      <main className="w-screen h-screen flex justify-center items-center">
        <div>
          <div className="text-center animate-appearance-in">
            <h3 className="text-2xl text-[#1C252E] font-bold mb-4">
              Sorry, page not found!
            </h3>
            <p className="text-base text-[#637381] font-normal">
              Sorry, we couldn’t find the page you’re looking <br />
              for. Perhaps you’ve mistyped the URL? Be sure to <br /> check your
              spelling.
            </p>
          </div>
          <div className="flex justify-center py-20 animate-appearance-in">
            <svg
            ...
            >
              ...
              ></path>
              <image
                href="https://assets.minimals.cc/public/assets/illustrations/characters/character-6.webp"
                height="300"
                x="205"
                y="30"
              ></image>
          ...
          <div className="flex justify-center">
            <Link to={"/"}>
              <button
                className="bg-[#18181b] font-semibold text-white hover:bg-[#27272a] transition-transform-background hover:shadow-lg h-12 focus:outline-none"
                radius="sm"
              >
                Go to home
              </button>
