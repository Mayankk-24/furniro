  ...
  return (
    <>
            ...
            <Form>
              <div className="mb-6">
                ...
                <Field
                  ...
                  name="name"
                  placeholder="abc"
                  className="border-1 rounded-lg w-full py-3 px-5 mt-4"
                />
                <ErrorMessage
                  className="text-xs mt-1 text-red-600 font-semibold"
                  name="name"
                  component={"div"}
                />
              </div>
              ...
              <div className="mb-6">
                ...
                <Field
                  ...
                  className="border-1 rounded-lg w-full py-10   px-5 mt-4 placeholder:absolute placeholder:top-5"
                />
                <ErrorMessage
                  className="text-xs mt-1 text-red-600 font-semibold"
                  name="msg"
              ...
              <div className="mt-10">
                <button
                  type="submit"
                  className="text-white bg-primary focus:outline-none rounded-md px-16"
                >
                  Submit
                </button>
              </div>
      ...
      <div className="px-20 mb-10">
        <h2 className="text-4xl text-black font-semibold text-center mb-8">
