...
function Blog() {
  ...
  const BlogPost = [
    {
      id: 1,
      img: "/Assets/41417cd682c30a19eecaf20a549cee89.jpg",
      tag: "Wood",
      title: "Going all-in with millennial design",
    },
    {
      id: 2,
      img: "/Assets/96ed5dc3b3d01cf6cd369ef7aff2f296.jpg",
      tag: "Handmade",
      title: "Exploring new ways of decorating",
    },
    {
      id: 3,
      img: "/Assets/4190307dc6c7273c0bbf5086605997e4.jpg",
      tag: "Wood",
  ...
  const RecentPosts = [
    {
      id: 1,
      img: "/Assets/8b94b8e3a17bbb18c564006d557e73b1.jpg",
      title: `Going all-in with millennial design`,
    },
    {
      id: 2,
      img: "/Assets/309ac985861a262b8622e7528e08049f.jpg",
      title: "Exploring new ways of decorating",
    },
    {
      id: 3,
      img: "/Assets/6615f4968338e0a7004a86529ecf85c9.jpg",
      title: "Handmade pieces that took time to make",
    },
    {
      id: 4,
      img: "/Assets/cfbc72a9932875eeb20db551bb01abb3.jpg",
      title: "Modern home in Milan",
    },
    {
      id: 5,
      img: "/Assets/7de5c930d1538360f43cbfa1d7f00337.jpg",
          ...
          {BlogPost.map((item, index) => {
            return (
              <div className="mb-10" key={index}>
                ...
                <div>
                  <h2 className="text-3xl font-medium text-black my-5">
                    {item.title}
                  </h2>
                  <p className="text-[#9F9F9F] text-justify">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed
                    do eiusmod tempor incididunt ut labore et <br /> dolore
                    magna aliqua. Mus mauris vitae ultricies leo integer
                    malesuada nunc. In nulla posuere sollicitudin <br /> aliquam
                    ultrices. Morbi blandit cursus risus at ultrices mi tempus
                    imperdiet. Libero enim sed faucibus <br /> turpis in. Cursus
                    mattis molestie a iaculis at erat. Nibh cras pulvinar mattis
                    nunc sed blandit libero. <br /> Pellentesque elit
                    ullamcorper dignissim cras tincidunt. Pharetra et ultrices
                    neque ornare aene <br /> an euismod elementum.
                  </p>
                  <h3 className="text-base text-black text-justify underline underline-offset-8 mt-7">
                    Read more
                  </h3>
                </div>
              </div>
        ...
        <div className="w-full">
          <div className="py-10 px-10">
            <div className=" flex items-center relative">
              <input
                type="text"
                className="border-1 border-gray-400 rounded-lg py-2 w-full"
              />
              <RiSearch2Line
                size={20}
                color="black"
          ...
          <div className="mt-11 pl-20">
            <h2 className="text-2xl text-black font-medium mb-5">
              Recent Posts
            </h2>
