  ...
  const showCards = async () => {
    try {
      ...
      const res = await axios.get(
        `${url}card/productcard?page=${currentPage}${_sortby}${_size}`
      );
  ...
  return (
    <>
      ...
      <div
        ...
        className="px-16 py-6 flex justify-between"
      >
        <div className="flex items-center gap-4">
          ...
          <p className="text-base text-black">
            Showing 1-{size} of {total} results
          </p>
        </div>
        <div className="flex items-center">
          ...
          <select
            ...
            className="bg-white rounded focus:outline-none text-gray-400 flex items-center justify-center mr-8"
          ...
          <select
            ...
            className="px-4 rounded focus:outline-none"
          >
      ...
      <div className="flex gap-5 items-center justify-center mb-16">
        ...
        <Button
          ...
          onPress={() =>
            setCurrentPage((prev) =>
              prev < Math.ceil(total / size) ? prev + 1 : prev
            )
          }
          className="focus:outline-none outline-none"
        >
